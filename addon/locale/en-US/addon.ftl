...
batch-stopped = { $count } left untouched
...
import-write-failed = Could not save the import. None of its records were applied; fix the reported problem and retry. { $error }
...
migrate-report-line = Legacy parents: { $parents } · notes: { $notes } · parsed: { $parsed } · skipped: { $skipped } · files: { $files } · off-by-one fixed: { $offset } · unresolved keys: { $unresolved } · ambiguous keys: { $ambiguous } · merged: { $merged } ({ $hours } h)
import-sum-unallocated = These histories have different page and date coverage, so their sum cannot be preserved exactly. No changes were made to this record. Use the larger-value (max) merge, or import matching page/date detail.
...
# ---- graph ----
graph-title = Library relations
graph-mode-related = Item links
...
anno-page = Page { $page }
anno-copy = Copy text
anno-action-copy = Copy
anno-card-tip = Use Go to annotation or double-click the page label; text can be selected and copied
...
rank-value-xr-short = XR { $value }
rank-value-xr-long = XinRui Journal Ranking — { $value }
rank-value-cas-short = CAS { $value }
rank-value-cas-long = CAS Journal Ranking (historical) — { $value }
...
pref-key-cleared = Key removed
pref-key-clear-pending = Key disabled in Zest. The login manager could not confirm deletion; unlock it and click Save again to retry removal.
...
citations-done = { $updated } updated · { $unchanged } unchanged · { $missing } without an identifier · { $notFound } not found · { $failed } failed · { $stopped } left untouched
...
info-citation-key-copy-failed = Copy failed; select the text to copy it manually
...
stats-zero-time = 0 min
stats-hours = { $value } h
stats-minutes = { $value } min
stats-seconds = { $value } s
stats-goals = Your reading rhythm
stats-today = Today
stats-ring-today = Today’s reading
stats-ring-week-time = This week’s reading
stats-ring-week-days = Days on target
stats-day-count = { $days } days
stats-goal-reached = Goal reached
stats-goal-remaining = { $value } to go
stats-future-day = Upcoming
stats-goal-week-note = Monday–Sunday · A day counts after { $minutes } minutes. Weekly time target = daily goal × target days.
stats-goal-daily = Daily goal
stats-goal-weekly = Days per week
stats-minute-option = { $value } min
stats-day-option = { $value } days
stats-category-seconds = Time
stats-category-items = Exploration
stats-category-days = Consistency
stats-next-milestone = Next milestone
stats-unavailable-item = Unavailable item
stats-subtitle = Your reading, in perspective. All records stay on this device.
stats-refresh = Refresh
stats-not-ready = Reading records are still loading. Refresh in a moment.
stats-empty = Your reading journey starts here. Open a PDF or EPUB and read in the foreground with reading tracking enabled.
stats-page-total = Pages explored
stats-page-note = Days count any recorded reading. Pages count primary-attachment pages with at least 5 recorded seconds; they do not imply completion.
stats-undated = { $time } is not assigned to dates. It is included in the lifetime total, but not in daily charts.
stats-inconsistent = Some imported date totals exceed their item totals. Charts use date records; lifetime totals use item records. These measures are shown separately.
stats-trend = Reading trend
stats-range-label = Time range
stats-range = { $days } days
stats-period-total = Period total
stats-period-days = Active days
stats-average = Daily average
stats-no-previous = No reading recorded in the preceding period · average includes all calendar days
stats-comparison = { $change } vs. the preceding { $days } days · average includes all calendar days
stats-no-period-data = No reading recorded in this period · average includes all calendar days
stats-trend-accessible = Daily reading over { $days } days, totaling { $time }. Exact values are in the daily data table below.
stats-data-table = View daily data
stats-date = Date
stats-weekdays-title = Weekly rhythm
stats-weekdays-note = Time by weekday within the selected period
stats-calendar = A year of reading
stats-best-detail = All-time best day: { $day } · { $time }
stats-less = Less
stats-more = More
stats-achievements = Reading milestones
stats-achievements-count = { $count } of { $total } reached
stats-achievement-first-reading = First steps
stats-achievement-time-1h = One hour
stats-achievement-time-10h = Ten hours
stats-achievement-time-50h = Fifty hours
stats-achievement-items-10 = Ten papers
stats-achievement-items-50 = Fifty papers
stats-achievement-streak-3 = Three-day rhythm
stats-achievement-streak-7 = A week of reading
stats-achievement-streak-30 = Thirty-day rhythm
stats-unlocked = Reached
stats-in-progress = In progress
stats-achievement-rule-items = Read { $target } items for at least 5 minutes each
stats-achievement-rule-days = Read for at least 5 minutes on { $target } consecutive days
stats-achievement-rule-time = Accumulate { $target } of reading
stats-achievements-note = Calculated from current local records, not proof of completing a paper. Importing or clearing records may change progress.
stats-top-note = All time · up to 12 items · ranked by recorded reading time
stats-no-items = Your most-read items will appear here.
...
stats-source-note = Local reading records only · Snapshot updated on open or Refresh · Export from Settings → Zest → Reading data.

# ---- annotation matrix ----
menu-matrix =
    .label = Annotation matrix…
sidebar-stats-header =
    .label = Zest · Reading statistics
sidebar-stats-sidenav =
    .tooltiptext = Zest · Reading statistics
sidebar-matrix-header =
    .label = Zest · Annotation matrix
sidebar-matrix-sidenav =
    .tooltiptext = Zest · Annotation matrix
sidebar-graph-header =
    .label = Zest · Library relations
sidebar-graph-sidenav =
    .tooltiptext = Zest · Library relations
sidebar-open-window =
    .tooltiptext = Open in a separate window
sidebar-open-graph =
    .tooltiptext = Expand below the library
sidebar-stats-scope = All local reading history
sidebar-graph-view = Current library view
sidebar-graph-item = This paper and its local related items
sidebar-loading = Loading…
sidebar-load-failed = Could not load this panel.
sidebar-retry = Retry
sidebar-graph-select = Select a node to see its details.
sidebar-graph-open = Open paper
matrix-scope-current = This paper
matrix-title = Annotation matrix
matrix-search-placeholder = Search annotations, comments, papers or tags
matrix-all-colors = All colours
matrix-all-tags = All tags
matrix-count = { $shown } of { $total } annotations
matrix-export-csv = Export CSV
matrix-export-md = Export Markdown
matrix-copy-md = Copy as Markdown
matrix-copied-md = Copied { $count } annotations. Paste into Obsidian or another Markdown editor.
matrix-col-item = Item
matrix-col-page = Page
matrix-col-text = Annotation
matrix-col-tags = Tags
matrix-subtitle = From close reading to your next draft
matrix-refresh = Refresh
matrix-export = Export
matrix-filters = Filters
matrix-scope = Scope
matrix-scope-view = Current view
matrix-scope-selected = Selected items
matrix-type = Annotation type
matrix-color = Colour
matrix-all-items = All papers
matrix-all-types = All types
matrix-search-help = Space joins terms; | matches alternatives; -word excludes; quotes match a phrase.
matrix-comments-only = With comments
matrix-sort = Sort
matrix-sort-source = Source order
matrix-sort-title = Paper title
matrix-reset = Reset
matrix-pagination = Result pages
matrix-previous = Previous
matrix-next = Next
matrix-range = { $start }–{ $end } of { $total }
matrix-loading = Gathering annotations…
matrix-unavailable = Annotations temporarily unavailable
matrix-empty-filter = No matching annotations
matrix-empty-filter-hint = Try another query or reset your filters.
matrix-empty = No annotations in this scope
matrix-empty-hint = Select papers or attachments with annotations and refresh, or switch to the current view.
matrix-untitled = Untitled paper
matrix-filter-item = Filter to this paper
matrix-filter-tag = Filter by tag: { $tag }
matrix-page = Page { $page }
matrix-comment = Comment
matrix-no-text = This annotation has no text. Open the source to view it.
matrix-expand = Show full text
matrix-collapse = Show less
matrix-open = Open source
matrix-copied = Copied
matrix-copy-failed = Could not copy. Please try again.
matrix-open-failed = Could not open the source. Check that the attachment is available.
matrix-load-failed = Could not read this scope. Check that the library window is open, then refresh.
matrix-export-hint = Copy or export all { $count } matching annotations, with source links.
matrix-exported = Exported { $count } annotations.
matrix-export-failed = Export failed. Check the save location and try again.
matrix-type-highlight = Highlight
matrix-type-underline = Underline
matrix-type-note = Note
matrix-type-text = Text
matrix-type-image = Image
matrix-type-ink = Ink
matrix-color-yellow = Yellow
matrix-color-red = Red
matrix-color-green = Green
matrix-color-blue = Blue
matrix-color-purple = Purple
matrix-color-magenta = Magenta
matrix-color-orange = Orange
matrix-color-gray = Grey
...
tabs-sidebar-label = Vertical tabs
...
graph-options = Filters and actions
graph-filter-modes = Relationship
graph-filter-roles = Author scope
graph-filter-shared = Shared-item threshold
graph-roles-firstlast = First + last
graph-roles-firstlast-tip = First and last authors by position; this does not identify corresponding authors
...
tags-rename-invalid = These tag names cannot be renamed safely in sequence. Choose a different branch name or matching rule.
graph-authors-complete = Complete author identities
graph-authors-complete-tip = Fetch missing author identities from OpenAlex for the current scope (up to 30 papers per click).
graph-authors-loading = Fetching author identities…
graph-authors-progress = Author identities: { $updated } updated · { $attempted } requested
graph-authors-done = Author identity lookup finished: { $updated } updated · { $attempted } requested
graph-authors-stopped = Author identity lookup stopped: { $updated } updated · { $attempted } requested; try again later
