...
pref-authors-preset-creator = Like Zotero's Creator column
pref-authors-preset-all = Every author
pref-authors-preset-first = First author only
pref-authors-preset-last = Last author only
pref-authors-preset-firstlast = First … last
pref-authors-preset-first3 = First N, then et al.
pref-authors-preset-advisor = Thesis advisor
pref-authors-count = N
pref-authors-order = Name order
pref-authors-order-auto = Automatic (CJK family-first, Latin given-first)
pref-authors-order-given = Given name first
pref-authors-order-family = Family name first
pref-authors-given = Given name
pref-authors-given-full = In full
pref-authors-given-initials = Initials
pref-authors-given-none = Hidden
pref-authors-marklast =
    .label = Mark the last author (often the corresponding one)
pref-authors-self = Highlight my name
pref-authors-hint = Marks are drawn separately from the text, so they never affect sorting. Separators follow the two adjacent names' scripts (王小明、李雷 but 王小明, John Smith).
...
pref-info-enable =
    .label = Show the Zest panel (authors, venue, ranks, citations, reading, rating)
pref-info-abstract =
