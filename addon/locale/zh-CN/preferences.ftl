...
pref-authors-preset-creator = 与 Zotero 原生 Creator 列一致
pref-authors-preset-all = 全部作者
pref-authors-preset-first = 仅第一作者
pref-authors-preset-last = 仅末位作者
pref-authors-preset-firstlast = 首位 … 末位
pref-authors-preset-first3 = 前 N 位后加 et al.
pref-authors-preset-advisor = 学位论文导师
pref-authors-count = N
pref-authors-order = 姓名顺序
pref-authors-order-auto = 自动（中日韩姓在前，拉丁名在前）
pref-authors-order-given = 名在前
pref-authors-order-family = 姓在前
pref-authors-given = 名
pref-authors-given-full = 全名
pref-authors-given-initials = 首字母
pref-authors-given-none = 不显示
